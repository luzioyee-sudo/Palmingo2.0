...
const dict: Record<LangCode, T> = {
  ar: {
    ...
    topics: "المواضيع", videos: "الفيديوهات", laxa_ai: "لاكسا AI", friends: "الأصدقاء",
  ...
  en: {
    ...
    topics: "Topics", videos: "Videos", laxa_ai: "Laxa AI", friends: "Friends",
  ...
  fr: {
    ...
    topics: "Sujets", videos: "Vidéos", laxa_ai: "Laxa AI", friends: "Amis",
  ...
  it: {
    ...
    topics: "Argomenti", videos: "Video", laxa_ai: "Laxa AI", friends: "Amici",
  ...
  de: {
    ...
    topics: "Themen", videos: "Videos", laxa_ai: "Laxa AI", friends: "Freunde",
  ...
  es: {
    ...
    topics: "Temas", videos: "Videos", laxa_ai: "Laxa AI", friends: "Amigos",
  ...
  pt: {
    ...
    topics: "Tópicos", videos: "Vídeos", laxa_ai: "Laxa AI", friends: "Amigos",
