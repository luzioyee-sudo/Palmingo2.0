...
const dict: Record<LangCode, T> = {
  ar: {
    ...
    topics: "المواضيع", videos: "الفيديوهات", laxa_ai: "لاكسا AI",
  ...
  en: {
    ...
    topics: "Topics", videos: "Videos", laxa_ai: "Laxa AI",
  ...
  fr: {
    ...
    topics: "Sujets", videos: "Vidéos", laxa_ai: "Laxa AI",
  ...
  it: {
    ...
    topics: "Argomenti", videos: "Video", laxa_ai: "Laxa AI",
  ...
  de: {
    ...
    topics: "Themen", videos: "Videos", laxa_ai: "Laxa AI",
  ...
  es: {
    ...
    topics: "Temas", videos: "Videos", laxa_ai: "Laxa AI",
  ...
  pt: {
    ...
    topics: "Tópicos", videos: "Vídeos", laxa_ai: "Laxa AI",
